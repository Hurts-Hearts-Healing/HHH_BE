...
class EmotionAnalysisService(
    ...
    override fun findByUserIdAndDiaryId(diaryId: String): Mono<EmotionAnalysisInternalDTO> {
        return currentUser.getCurrentUser()
            .switchIfEmpty(Mono.error(CustomExceptionFactory.unauthorized(ErrorCode.AUTH_005)))
            .flatMap { user ->
                val userId = user.userId
                ...
                emotionAnalysisRepository.findByUserIdAndDiaryId(userId.toString(), DiaryId(diaryId).toString())
            }
    }
}
